...
#read data from csv
with open(inp_filename, 'r', newline='') as in_Whitney:

    reader = csv.DictReader(in_Whitney)

    with open(out_filename, 'w', newline='') as out_Whitney:
        writer = csv.writer(out_Whitney)
