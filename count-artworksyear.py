...
out_filename = "artworkyear-wh.csv"
...
Museum = "Whitney"
artwork_id_lookup = {}
unique_artwork_id_number = 25580
...
with open(inp_filename, 'r', newline='') as in_WH:
    ...
    with open(out_filename, 'w', newline='') as out_WH:
        ...
        for row in reader:
            ...
            writer.writerow([titlecol,final_date2])

            #writer.writerow([clean_up_artwork,artwork_id_lookup[clean_up_artwork]])
